...
document.querySelector('.business-enquiry-form').addEventListener('submit', async (event) => {
  ...
  try {
    ...
    const response = await axios.post(`/business-loan-enquiry/${productId}`, formData);
    Swal.fire({
