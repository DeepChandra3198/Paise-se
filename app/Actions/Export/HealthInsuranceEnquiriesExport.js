...
const HealthInsuranceEnquiriesExport = async (req, res) => {
  try {
    ...
    const dataArray = await prisma.healthInsuranceEnquiries.findMany({
      orderBy: [
        {
          id: 'desc',
        },
    ...
    res.setHeader('Content-Disposition', 'attachment; filename=HealthInsuranceEnquiries.xlsx');
