...
const HomeLoanEnquiriesExport = async (req, res) => {
  try {
    ...
    const dataArray = await prisma.HomeLoanEnquiries.findMany({
      orderBy: [
        {
          id: 'desc',
        },
    ...
    res.setHeader('Content-Disposition', 'attachment; filename=HomeLoanEnquiries.xlsx');
