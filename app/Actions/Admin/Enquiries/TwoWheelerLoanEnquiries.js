...
async function TwoWheelerLoanEnquiries(req, res) {
  ...
  const queries = await WebPaginate(req, res, 'TwoWheelerLoanEnquiries', {
    orderBy: [
      {
        id: 'desc',
      },
  ...
  return res.render('admin/product/enquiries/two-wheeler-loan-enquiries', {
    queries,
