...
async function LapLoanEnquiries(req, res) {
  ...
  const queries = await WebPaginate(req, res, 'LapLoanEnquiries', {
    orderBy: [
      {
        id: 'desc',
      },
  ...
  return res.render('admin/product/enquiries/lap-loan-enquiries', {
    queries,
