...
async function CarLoanEnquiries(req, res) {
  ...
  const queries = await WebPaginate(req, res, 'CarLoanEnquiries', {
    orderBy: [
      {
        id: 'desc',
      },
  ...
  return res.render('admin/product/enquiries/car-loan-enquiries', {
    queries,
