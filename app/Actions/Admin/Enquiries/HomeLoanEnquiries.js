...
async function HomeLoanEnquiries(req, res) {
  ...
  const queries = await WebPaginate(req, res, 'HomeLoanEnquiries', {
    orderBy: [
      {
        id: 'desc',
      },
  ...
  return res.render('admin/product/enquiries/home-loan-enquiries', {
    queries,
