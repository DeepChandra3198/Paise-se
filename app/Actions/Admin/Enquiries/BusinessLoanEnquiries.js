...
async function BusinessLoanEnquiries(req, res) {
  ...
  const queries = await WebPaginate(req, res, 'BusinessLoanEnquiries', {
    orderBy: [
      {
        id: 'desc',
      },
  ...
  return res.render("admin/product/enquiries/business-loan-enquiries", {
    queries,
